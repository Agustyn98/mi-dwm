...
# Dependencies: rofi, thunar, chromium, alacritty, brightnessctl, xorg-xinput, otf-font-awesome, numlockx, feh, network-manager-applet, xorg-xsetroot, gnome-screenshot, galculator, calendar.sh in /usr/local/bin
